...
typedef	void ipc_dispatch_callback_t(const struct ipc_dispatch *, const struct ipc_dispatch_handler *, const struct ipc_header *, void *);
...
const struct ipc_dispatch_handler *ipc_dispatch_register_default(struct ipc_dispatch *, ipc_dispatch_callback_t *, void *);
int ipc_dispatch_send(const struct ipc_dispatch *, const struct ipc_dispatch_handler *, ipc_port_t, ipc_msg_t, ipc_port_right_t, const void *, size_t);
int ipc_dispatch_send_reply(const struct ipc_dispatch *, const struct ipc_header *, ipc_port_right_t, const void *, size_t);
